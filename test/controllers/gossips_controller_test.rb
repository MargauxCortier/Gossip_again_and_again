...
class GossipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gossip" do
    assert_difference('Gossip.count') do
      post gossips_url, params: { gossip: { anonymous_gossiper: @gossip.anonymous_gossiper, content: @gossip.content } }
    end
  ...
  test "should update gossip" do
    patch gossip_url(@gossip), params: { gossip: { anonymous_gossiper: @gossip.anonymous_gossiper, content: @gossip.content } }
